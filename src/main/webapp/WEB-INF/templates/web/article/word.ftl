<div class="form-group">
    <div class="col-xs-12">
        ...
        <input id="title" name="title" class="form-control" placeholder="有标题可以让别人更容易看到..."/>
...
<div class="form-group">
    <div class="col-xs-12">
        ...
        <textarea id="body" rows="16" name="body" class="form-control" placeholder="随手写一句吧..."></textarea>
