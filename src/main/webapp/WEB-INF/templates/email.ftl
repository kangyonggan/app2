                        ...
                        <table class="table-space" height="18"
                            ...
                            <tr>
                                <td class="table-space-td" valign="middle" height="18"
                                    style="height: 18px; width: 450px; background-color: #e4e6e9;" width="450"
                        ...
                        <table class="table-space" height="8"
                            ...
                            <tr>
                                <td class="table-space-td" valign="middle" height="8"
                                    style="height: 8px; width: 450px; background-color: #ffffff;" width="450"
                        ...
                        <table class="table-row" width="450" bgcolor="#FFFFFF"
                            ...
                            <tr>
                                <td class="table-row-td"
                                    ...
                                    <table class="table-col" align="left" width="378" cellspacing="0" cellpadding="0"
                                        ...
                                        <tr>
                                            <td class="table-col-td" width="378"
                                                ...
                                                valign="top" align="left">
                                                <table class="header-row" width="378" cellspacing="0" cellpadding="0"
                                                       border="0" style="table-layout: fixed;">
                                                    <tbody>
                                                    <tr>
                                                        <td class="header-row-td" width="378"
                                                            style="font-family: Arial, sans-serif; font-weight: normal; line-height: 16px; color: #478fca; margin: 0px; font-size: 18px; padding-bottom: 10px; padding-top: 15px;"
                                                            valign="top" align="left">
                                                            <b style="color: #404040;">
                                                            ${title}
                                                            </b><br>
                                                            <small style="font-size: 12px">如果按钮无法点击，请将下面的地址复制到你浏览器的地址栏中打开，该链接地址24小时内有效.</small>
                                                            <br>
                                                            <br>
                                                            <a target="_blank" style="font-size: 14px;" href="${url}">${url}</a>
                                                            <br>
                                                        </td>
                                                    </tr>
                                                    </tbody>
                        ...
                        <table class="table-space" height="12"
                            ...
                            <tr>
                                <td class="table-space-td" valign="middle" height="12"
                                    style="height: 12px; width: 450px; background-color: #ffffff;" width="450"
                                    bgcolor="#FFFFFF" align="left">&nbsp;</td>
                            </tr>
                            </tbody>
                        </table>
                        <table class="table-space" height="12"
                            ...
                            <tr>
                                <td class="table-space-td" valign="middle" height="12"
                                    ...
                                    <table bgcolor="#E8E8E8" height="0" width="100%" cellspacing="0" cellpadding="0"
                                           border="0">
                                        <tbody>
                                        <tr>
                                        ...
                                        <tr>
                                            <td class="table-col-td" width="378"
                                                ...
                                                <table class="table-space" height="16"
                                                       ...
                                                       width="378" bgcolor="#FFFFFF" cellspacing="0" cellpadding="0"
                                                       border="0">
                                                    <tbody>
                                                    <tr>
                                                        <td class="table-space-td" valign="middle" height="16"
                        ...
                        <table class="table-row-fixed" width="450" bgcolor="#FFFFFF"
                            ...
                            <tr>
                                <td class="table-row-fixed-td"
                                    ...
                                    valign="top" align="left">
                                    <table class="table-col" align="left" width="448" cellspacing="0" cellpadding="0"
                                           border="0" style="table-layout: fixed;">
                                        <tbody>
                                        <tr>
