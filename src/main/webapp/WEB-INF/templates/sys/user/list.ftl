...
<form class="form-inline items-form" method="get" novalidate>
    ...
    <div class="pull-right">
        <a href="${ctx}sys/user/create" class="btn btn-sm skin-btn" data-backdrop="static" data-toggle="modal" data-target="#myModal">添加</a>
    </div>
</form>
...
<@c.pagination url="${ctx}sys/user/list" param="email=${email}&realname=${realname}"/>
</@override>
